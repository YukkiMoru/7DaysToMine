...
class ToolFactory(private val plugin: JavaPlugin) {
    ...
    private val EarlyStagePickaxe: Map<Material, OreData> = mapOf(
        Material.COAL_ORE to OreData("石炭鉱石", 1.0, 1.0, 1.0),
        Material.IRON_ORE to OreData("鉄鉱石", 1.0, 1.0, 1.0),
    )

    private val MidStagePickaxe: Map<Material, OreData> = mapOf(
        Material.COAL_ORE to OreData("石炭鉱石", 1.0, 1.0, 1.0),
        Material.IRON_ORE to OreData("鉄鉱石", 1.0, 1.0, 1.0),
        Material.DEEPSLATE_IRON_ORE to OreData("深層鉄鉱石", 0.8, 1.5, 1.0),
        Material.RED_STAINED_GLASS to OreData("ルビー鉱石", 0.5, 1.0, 1.0),
        Material.RED_STAINED_GLASS_PANE to OreData("ルビー鉱石", 0.7, 0.5, 1.0),
    )
    ...
    fun createUnbreakableTool(
        ...
        val itemStack = itemFactory.createItemStack(material, 1, name, lore, rarity)
    ...
    fun createLateStagePickaxe(): ItemStack {
        val destroyableBlocks = "minecraft:coal_ore:1.0:1.0,minecraft:iron_ore:1.0:1.0,minecraft:deepslate_iron_ore:0.8:1.5,minecraft:red_stained_glass:0.5:1.0,minecraft:red_stained_glass_pane:0.7:0.5"
        return createUnbreakableTool(
